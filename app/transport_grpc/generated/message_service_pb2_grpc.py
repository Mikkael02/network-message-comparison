...
from app.transport_grpc.generated import message_service_pb2 as app_dot_transport__grpc_dot_generated_dot_message__service__pb2
...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in app/transport_grpc/generated/message_service_pb2_grpc.py depends on'
...
def add_MessageServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'messagecomparison.MessageService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('messagecomparison.MessageService', rpc_method_handlers)
